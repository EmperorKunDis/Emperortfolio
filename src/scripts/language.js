...
if (window.location.hash) {
  if (window.location.hash == "#de") {
    ...
    message_input.placeholder.innerHTML = language.de.message_input;
    message01_input.placeholder.innerHTML = language.de.message01_input;
    message02_input.placeholder.innerHTML = language.de.message02_input;
    message03_input.placeholder.innerHTML = language.de.message03_input;
    message04_input.placeholder.innerHTML = language.de.message04_input;
    ...
    message_input.placeholder.innerHTML = language.cz.message_input;
    message01_input.placeholder.innerHTML = language.cz.message01_input;
    message02_input.placeholder.innerHTML = language.cz.message02_input;
    message03_input.placeholder.innerHTML = language.cz.message03_input;
    message04_input.placeholder.innerHTML = language.cz.message04_input;
  }
}
